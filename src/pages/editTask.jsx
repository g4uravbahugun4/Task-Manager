    ...
    <div className='w-1/2 m-auto py-10 rounded-md  shadow-2xl'>
        ...
        <div className="flex flex-col items-end gap-6">
          <Input
            ...
            onChange={(e) => setFormData({...formData, 
             name: e.target.value,status:'incmomplete'})
             }
          />
          <Textarea
            label="Description"
            ...
            onChange={(e) => setFormData({...formData, 
             description: e.target.value,status:'incomplete'})
             }
          />
          <Select
      ...
      <DialogFooter>
        <Button
          variant="text"
          color="red"
          onClick={() => navigate('/')} // Navigate back to the home page on cancel
          className="mr-1"
        >
          <span>Cancel</span>
        </Button>
